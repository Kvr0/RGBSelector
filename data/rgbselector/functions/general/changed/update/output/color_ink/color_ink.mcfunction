...
execute if score $InkCheck Temporary matches 1 run function customguicore:blockgui/api/consume/_

execute if score $InkCheck Temporary matches 1 run data modify storage customguicore: Input.SetItem set value {Slot:26b, id:"minecraft:potion", Count:1b,tag:{CustomPotionColor:0,display:{Name:'{"text":"ColorInk","italic":false}'},HideFlags:127}}
...
execute if score $InkCheck Temporary matches 1 run data modify storage customguicore: Input.SetItem.tag.display.Lore append from block -30000000 2 43885 Text1
execute if score $InkCheck Temporary matches 1 store result storage customguicore: Input.SetItem.tag.CustomPotionColor int 1 run scoreboard players get $RGBSelector.Color Temporary

execute if score $InkCheck Temporary matches 1 run function customguicore:blockgui/api/set_item/_
