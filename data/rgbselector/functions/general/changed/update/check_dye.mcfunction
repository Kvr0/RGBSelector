...
execute if data storage customguicore: {Temp:{RGBSelector:{ChangedItem:{id:"minecraft:red_dye"}}}} if score $RGBSelector.Dye.Red Temporary matches ..9900 run function customguicore:blockgui/api/consume/_
execute if data storage customguicore: {Temp:{RGBSelector:{ChangedItem:{id:"minecraft:green_dye"}}}} if score $RGBSelector.Dye.Green Temporary matches ..9900 run function customguicore:blockgui/api/consume/_
execute if data storage customguicore: {Temp:{RGBSelector:{ChangedItem:{id:"minecraft:blue_dye"}}}} if score $RGBSelector.Dye.Blue Temporary matches ..9900 run function customguicore:blockgui/api/consume/_
